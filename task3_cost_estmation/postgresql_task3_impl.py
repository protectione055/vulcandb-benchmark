...
from task3_cost_estmation.task3 import CostEstimator
...
class PGTask3Impl:
    ...
    def _get_create_table_sql(self, entity):
        create_table_sql = f"CREATE TABLE {entity.is_a()} (id INTEGER PRIMARY KEY, "  # 创建表的SQL语句
        attr_type_map = {
            "INT": "INTEGER",
