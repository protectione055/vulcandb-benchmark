...
from task1_geom_edit.task1 import *

class RawfileTask1Impl:
    def __init__(self):
        self.models = []
    
    def prepare_data(self, workloads):
        '''
        所有数据在运行测试时动态生成，因此不需要预处理
        '''
        pass
    ...
    def run(self):
        ...
        project = run("root.create_entity", model, ifc_class="IfcProject", name="VulcanDB Benchmark Task1")
        ...
        # Write out to a file
        model.write("results/rawfile-model-minimal2.ifc")

    def cleanup(self):
        pass
    
if __name__ == '__main__':
    task1 = RawfileTask1Impl()
    task1.prepare_data(None)
    task1.run()
    task1.cleanup()